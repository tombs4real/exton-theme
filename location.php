<?php include('inc/header.php'); ?>
      ...
      <div id="mapts_content" class="mapts-content">
        ...
        <div class="wrapper section">
          <p>Discover a neighborhood that makes home the destination. Located just moments away from BYU, UVU, and I-15, you’ll have the entire world at your fingertips and can travel with simplicity and ease. You can enjoy exploring local attractions, restaurants, outdoor recreation, and more at our Orem apartments. Enhance your daily routine by visiting University Place Mall’s great shopping and entertainment.</p>
          <p>Adventure outdoors to Provo Canyon, Sundance Resort, Mount Timpanogos Park, or Scera Park just up the road. Grab a bite to eat at Seven Brothers Burgers, Aubergine Kitchen, Maria Bonita Mexican Grill, Yamato Sushi, and more. At the end of each day, you will love coming home to our Orem apartments for rent where you can experience ongoing relaxation and rejuvenation. Come home to The Exton at University Place, and experience better living at the location you want.</p>
        </div>
        <!-- END SECTION -->

        <!-- SECTION  -->
        <div class="wrapper section">
          <h2>The Exton at University Place Neighborhood</h2>
          <hr class="block blue">
          <div class="col3">
            <div class="col">
        ...
        <!-- SECTION  -->
        <div class="wrapper section">
          <h2>Live at University Place in East Orem</h2>
          <hr class="block blue">
          <p>We think you will love it so much, you’ll want to live here, and now you can! A neighborhood at University Place! Now you can walk to work, walk to dinner, walk to the movies, or walk to the shops.</p>
          <div class="col3">
            <div class="col">
              <img src="img/needs-img.png" alt="">
